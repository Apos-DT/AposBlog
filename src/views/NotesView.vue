...
.nc-pin:hover { color: var(--accent-warm); background: oklch(0.92 0.06 60 / 0.3); transform: rotate(-15deg); }
.nc-del:hover { color: var(--error); background: oklch(0.92 0.06 25 / 0.3); transform: rotate(15deg); }
