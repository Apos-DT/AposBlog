const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomeView-ZVRoEjj5.js","assets/vue-CGH0Fj-A.js","assets/posts-v5dmQ8-R.js","assets/gsap-CzGW6FVa.js","assets/lenis-BEW9yqGz.js","assets/HomeView-Cyb7zeDd.css","assets/PostView-DaKrxD3l.js","assets/PostView-TxfRb_9n.css","assets/PlaygroundView-Dqsu8g6S.js","assets/PlaygroundView-C7ilfDtt.css","assets/DashboardView-BUhteBhE.js","assets/DashboardView-QLOZTLWq.css","assets/LibraryView-DVkosfm7.js","assets/LibraryView-ANUdwy8k.css","assets/NotesView-DSMJiFDi.js","assets/NotesView-ClrWPdxR.css","assets/NoteEditView-1rS6guRR.js","assets/NoteEditView-Dj8gQdlU.css","assets/TagsView-Dj1g9ADj.js","assets/TagsView-DuUoTcNE.css","assets/GraphView-D1pOjk3-.js","assets/echarts-qCor5qs6.js","assets/GraphView-BpwlWlHG.css","assets/ChatView-CypP7a1C.js","assets/chat-Brw3DTax.js","assets/ChatView-CvdWGtzO.css","assets/GuestbookView-BbjW9BY6.js","assets/GuestbookView-whUzw6Ct.css","assets/StatsView-DJFjVZVX.js","assets/StatsView-CPv1-0TE.css","assets/SettingsView-BHt1_ekC.js","assets/SettingsView-DFrInrQH.css","assets/NotFoundView-B2Z-vmh7.js","assets/NotFoundView-OKIYwxCK.css"])))=>i.map(i=>d[i]);
import{H as pt,n as q,u as L,s as K,r as Z,t as k,g as A,d as p,F as V,c as S,B as nt,z as E,A as y,v as ot,p as ht,l as b,I as C,R as T,k as D,K as ft,J as mt,G as gt,e as H,w as X,C as vt,f as kt,x as yt,a as _t,y as bt,i as wt,m as Mt,b as At,h as $t}from"./vue-CGH0Fj-A.js";import{L as St}from"./lenis-BEW9yqGz.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(e){if(e.ep)return;e.ep=!0;const a=n(e);fetch(e.href,a)}})();const z="apos";function Et(t,o){try{const n=localStorage.getItem(`${z}:${t}`);return n?JSON.parse(n):typeof o=="function"?o():o}catch(n){return console.warn("[apos] loadState failed",t,n),typeof o=="function"?o():o}}function rt(t,o){try{localStorage.setItem(`${z}:${t}`,JSON.stringify(o))}catch(n){console.warn("[apos] saveState failed",t,n)}}function F(t,o,n){const s=Et(t,n);for(const e of Object.keys(o))s&&s[e]!==void 0&&(o[e].value=s[e]);pt(()=>Object.fromEntries(Object.keys(o).map(e=>[e,o[e].value])),e=>rt(t,e),{deep:!0})}function ve(){const t=[];for(let o=0;o<localStorage.length;o++){const n=localStorage.key(o);n&&n.startsWith(`${z}:`)&&t.push(n)}t.forEach(o=>localStorage.removeItem(o))}function ke(){const t={};for(let o=0;o<localStorage.length;o++){const n=localStorage.key(o);if(n&&n.startsWith(`${z}:`))try{t[n.slice(z.length+1)]=JSON.parse(localStorage.getItem(n))}catch{}}return{version:1,exportedAt:new Date().toISOString(),data:t}}function ye(t){if(!t||!t.data)throw new Error("数据格式不正确");Object.entries(t.data).forEach(([o,n])=>{rt(o,n)})}const G=q("settings",()=>{const t=L(295),o=L(16),n=L(!1),s=L([]);F("settings",{hue:t,fontSize:o,reducedMotion:n},()=>({hue:295,fontSize:16,reducedMotion:!1}));function e(){const g=document.documentElement;g.style.setProperty("--accent",`oklch(0.72 0.21 ${t.value})`),g.style.fontSize=o.value+"px"}function a(g){t.value=Math.max(0,Math.min(360,parseInt(g,10)||0)),e()}function r(g){o.value=parseInt(g,10)||16,e()}function l(g,d,f=2800){const c=Math.random().toString(36).slice(2);s.value.push({id:c,type:g,text:d}),setTimeout(()=>{const i=s.value.findIndex(m=>m.id===c);i>=0&&(s.value[i].leaving=!0),setTimeout(()=>{s.value=s.value.filter(m=>m.id!==c)},300)},f)}return{hue:t,fontSize:o,reducedMotion:n,toasts:s,applyTheme:e,setHue:a,setFontSize:r,pushToast:l}}),xt={__name:"AppBackground",setup(t){const o=L(null);let n=null;return K(()=>{const s=o.value?o.value.querySelectorAll(".blob"):[];if(!s.length)return;const e=a=>{const r=a.clientX/window.innerWidth-.5,l=a.clientY/window.innerHeight-.5;s.forEach((g,d)=>{const f=(d+1)*14;g.style.transform=`translate3d(${r*f}px, ${l*f}px, 0)`})};window.addEventListener("mousemove",e,{passive:!0}),n=()=>window.removeEventListener("mousemove",e)}),Z(()=>n&&n()),(s,e)=>(k(),A(V,null,[e[1]||(e[1]=p("div",{class:"app-bg-grain","aria-hidden":"true"},null,-1)),p("div",{ref_key:"blobsEl",ref:o,class:"app-bg-aurora","aria-hidden":"true"},[...e[0]||(e[0]=[p("span",{class:"blob a"},null,-1),p("span",{class:"blob b"},null,-1),p("span",{class:"blob c"},null,-1)])],512)],64))}},Ct={__name:"AppCursor",setup(t){const o=L(null),n=L(null);let s=0,e=null;return K(()=>{if(!matchMedia("(hover: hover)").matches)return;const a={x:innerWidth/2,y:innerHeight/2},r={x:a.x,y:a.y},l=(_,P,j)=>_+(P-_)*j,g=_=>{a.x=_.clientX,a.y=_.clientY};window.addEventListener("mousemove",g,{passive:!0});const d=()=>{r.x=l(r.x,a.x,.16),r.y=l(r.y,a.y,.16),o.value&&(o.value.style.transform=`translate3d(${a.x-3}px, ${a.y-3}px, 0)`),n.value&&(n.value.style.transform=`translate3d(${r.x-18}px, ${r.y-18}px, 0)`),s=requestAnimationFrame(d)};d();const f=()=>document.body.classList.add("cursor-hover"),c=()=>document.body.classList.remove("cursor-hover"),i=()=>{document.querySelectorAll('a, button, .ui-card, .post-card, [data-cursor="link"]').forEach(_=>{_.addEventListener("mouseenter",f),_.addEventListener("mouseleave",c)})};i();const m=new MutationObserver(()=>i());m.observe(document.body,{childList:!0,subtree:!0}),e=()=>{cancelAnimationFrame(s),window.removeEventListener("mousemove",g),m.disconnect(),c()}}),Z(()=>e&&e()),(a,r)=>(k(),A(V,null,[p("div",{ref_key:"dot",ref:o,class:"app-cursor-dot","aria-hidden":"true"},null,512),p("div",{ref_key:"ring",ref:n,class:"app-cursor-ring","aria-hidden":"true"},null,512)],64))}},Lt=[{slug:"odoo-erp-manufacturing-customization",title:"在 Odoo 里做制造业 ERP 二开:销采产存质财全链路笔记",excerpt:"从客户手工 Excel 跑产线,到 Odoo 把销售-采购-库存-生产-质检-财务跑通。这篇拆开几个月里的关键二开决策与踩坑。",tag:"ERP",date:"2026-05-13",readTime:12,external:!1,url:"../../post.html?slug=odoo-erp-manufacturing-customization"},{slug:"industrial-vision-system-pitfalls",title:"工业机器视觉现场交付的 5 个稳定性陷阱",excerpt:"上位机/下位机联调、产线异常定位、通信稳定性优化——实验室能跑、现场就崩的真实原因。",tag:"Vision",date:"2026-04-22",readTime:10,external:!1,url:"../../post.html?slug=industrial-vision-system-pitfalls"},{slug:"springboot-vue-fullstack-craft",title:"Spring Boot + Vue3 全栈工程化:从权限到大屏的实战沉淀",excerpt:"在既有项目上做功能迭代、权限增强、数据可视化大屏。Spring Boot + Vue3 的连接处藏着多少坊。",tag:"Fullstack",date:"2025-09-18",readTime:8,external:!1,url:"../../post.html?slug=springboot-vue-fullstack-craft"},{slug:"python-scraping-pandas-django",title:"用 Selenium + Pandas + Django 做一套招聘数据采集分析",excerpt:"从爬取动态页面,到 Pandas 清洗,再到 Django 可视化展示——一个完整的数据小项目从 0 到 1。",tag:"Data",date:"2025-06-08",readTime:7,external:!1,url:"../../post.html?slug=python-scraping-pandas-django"}],Ot=[{id:"t-erp",name:"ERP",color:"oklch(0.74 0.20 295)"},{id:"t-vision",name:"Vision",color:"oklch(0.80 0.17 220)"},{id:"t-fullstack",name:"Fullstack",color:"oklch(0.84 0.15 60)"},{id:"t-data",name:"Data",color:"oklch(0.80 0.17 160)"},{id:"t-study",name:"学习",color:"oklch(0.77 0.18 320)"},{id:"t-think",name:"思考",color:"oklch(0.80 0.15 30)"},{id:"t-cheat",name:"速查",color:"oklch(0.76 0.17 180)"}],It=[{id:"n-welcome",title:"欢迎使用 APOS 知识库",content:`---
type: meta
status: pinned
date: 2026-05-20
---
...
`)+(o||"")}const Q=/\[\[([^\]|]+?)(?:\|([^\]]+?))?\]\]/g,Y=/(^|[\s\(])#([a-zA-Z0-9_\-一-龥]{1,30})\b/g;function tt(t){if(!t)return[];const o=new Set;let n;for(Q.lastIndex=0;(n=Q.exec(t))!==null;)o.add(n[1].trim());return Array.from(o)}function Rt(t){if(!t)return[];const o=new Set;let n;for(Y.lastIndex=0;(n=Y.exec(t))!==null;)o.add(n[2]);return Array.from(o)}function I(t){return String(t).replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function O(t){return I(t)}function be(t,o={}){const{body:n}=at(t||""),s=o.onLink||(()=>null),e=n.replace(/\r\n/g,`
`).split(`
`),a=[];let r=0;for(;r<e.length;){const l=e[r];if(/^```/.test(l)){const f=l.replace(/^```/,"").trim(),c=[];for(r++;r<e.length&&!/^```/.test(e[r]);)c.push(e[r]),r++;r++,a.push(`<pre><code${f?` data-lang="${O(f)}"`:""}>${I(c.join(`
`))}</code></pre>`);continue}if(/^\s*---+\s*$/.test(l)){a.push("<hr/>"),r++;continue}const g=l.match(/^(#{1,6})\s+(.*)$/);if(g){a.push(`<h${g[1].length}>${N(g[2],s)}</h${g[1].length}>`),r++;continue}if(/^>\s?/.test(l)){const f=[];for(;r<e.length&&/^>\s?/.test(e[r]);)f.push(e[r].replace(/^>\s?/,"")),r++;const c=f.join(" ").trim(),i=c.match(/^\[!(INFO|TIP|SUCCESS|NOTE|WARNING|WARN|ERROR|DANGER)\]\s*(.*)$/i);if(i){const m=i[1].toUpperCase(),_={INFO:"info",TIP:"tip",SUCCESS:"success",NOTE:"note",WARNING:"warning",WARN:"warning",ERROR:"error",DANGER:"error"}[m],P={INFO:"Info",TIP:"Tip",SUCCESS:"Success",NOTE:"Note",WARNING:"Warning",WARN:"Warning",ERROR:"Error",DANGER:"Danger"}[m];a.push(`<aside class="md-admon md-admon-${_}"><strong>${P} ·</strong> ${N(i[2],s)}</aside>`)}else a.push(`<blockquote>${N(c,s)}</blockquote>`);continue}if(/^\s*[-*]\s+/.test(l)){const f=[];for(;r<e.length&&/^\s*[-*]\s+/.test(e[r]);)f.push(`<li>${N(e[r].replace(/^\s*[-*]\s+/,""),s)}</li>`),r++;a.push(`<ul>${f.join("")}</ul>`);continue}if(/^\s*\d+\.\s+/.test(l)){const f=[];for(;r<e.length&&/^\s*\d+\.\s+/.test(e[r]);)f.push(`<li>${N(e[r].replace(/^\s*\d+\.\s+/,""),s)}</li>`),r++;a.push(`<ol>${f.join("")}</ol>`);continue}if(/^\s*$/.test(l)){r++;continue}const d=[l];for(r++;r<e.length&&!/^\s*$/.test(e[r])&&!/^(#{1,6}\s|```|>|\s*[-*]\s|\s*\d+\.\s|---+)/.test(e[r]);)d.push(e[r]),r++;a.push(`<p>${N(d.join(" "),s)}</p>`)}return a.join(`
`)}function N(t,o){if(!t)return"";const n=[];let s=t.replace(/`([^`]+?)`/g,(e,a)=>(n.push(a),`\0CODE${n.length-1}\0`));return s=I(s),s=s.replace(/\[\[([^\]|]+?)(?:\|([^\]]+?))?\]\]/g,(e,a,r)=>{const l=a.trim(),g=(r||a).trim(),d=o({type:"wiki",target:l,label:g});return d==null?`<span class="md-wiki md-wiki-missing" title="未链接的笔记: ${O(l)}">${I(g)}</span>`:`<a class="md-wiki" href="${O(d)}" data-wiki="${O(l)}">${I(g)}</a>`}),s=s.replace(/!\[([^\]]*)\]\(([^)\s]+)(?:\s+"[^"]*")?\)/g,(e,a,r)=>{const l=a.trim(),g=r.trim(),d=l.match(/^video(?::(.*))?$/i);if(d){const c=(d[1]||"").trim();return`<figure class="md-media"><video controls preload="metadata" src="${O(g)}"></video>${c?`<figcaption>${I(c)}</figcaption>`:""}</figure>`}const f=l.match(/^audio(?::(.*))?$/i);if(f){const c=(f[1]||"").trim();return`<figure class="md-media"><audio controls preload="metadata" src="${O(g)}"></audio>${c?`<figcaption>${I(c)}</figcaption>`:""}</figure>`}return`<img alt="${O(l)}" src="${O(g)}" loading="lazy"/>`}),s=s.replace(/\[([^\]]+)\]\(([^)\s]+)(?:\s+"[^"]*")?\)/g,(e,a,r)=>{const l=r.trim(),g=/^https?:\/\//i.test(l),f=o({type:"url",target:l,label:a})||l;return`<a href="${O(f)}"${g?' target="_blank" rel="noopener"':""}>${a}</a>`}),s=s.replace(/(^|\s)#([a-zA-Z0-9_\-一-龥]{1,30})\b/g,(e,a,r)=>{const l=o({type:"tag",target:r,label:r});return l?`${a}<a class="md-tag" href="${O(l)}">#${I(r)}</a>`:`${a}<span class="md-tag">#${I(r)}</span>`}),s=s.replace(/\*\*([^*]+?)\*\*/g,"<strong>$1</strong>"),s=s.replace(/(^|[\s>(])\*([^*\n]+?)\*(?=[\s<.,!?:;)]|$)/g,"$1<em>$2</em>"),s=s.replace(/(^|[\s>(])_([^_\n]+?)_(?=[\s<.,!?:;)]|$)/g,"$1<em>$2</em>"),s=s.replace(/ CODE(\d+) /g,(e,a)=>`<code>${I(n[+a])}</code>`),s}function Tt(){return"n-"+Math.random().toString(36).slice(2,9)+Date.now().toString(36).slice(-4)}const lt=q("notes",()=>{const t=L([]);F("notes",{notes:t},()=>({notes:st.notes}));const o=S(()=>{const u={};return t.value.forEach(h=>{h.title&&(u[h.title.toLowerCase().trim()]=h.id)}),u}),n=S(()=>{const u={};return t.value.forEach(h=>{const v=tt(h.content||"");u[h.id]=v.map(M=>o.value[M.toLowerCase().trim()]).filter(M=>M&&M!==h.id)}),u}),s=S(()=>{const u={};return t.value.forEach(h=>{u[h.id]=[]}),Object.entries(n.value).forEach(([h,v])=>{v.forEach(M=>{u[M]&&!u[M].includes(h)&&u[M].push(h)})}),u}),e=S(()=>{const u={};return t.value.forEach(h=>{u[h.id]=Rt(h.content||"")}),u}),a=S(()=>{const u={};return t.value.forEach(h=>{u[h.id]=at(h.content||"").meta}),u}),r=S(()=>[...t.value].sort((u,h)=>!!u.pinned!=!!h.pinned?u.pinned?-1:1:(h.updatedAt||"").localeCompare(u.updatedAt||"")));function l(u){return t.value.find(h=>h.id===u)}function g(u){if(!u)return null;const h=o.value[u.toLowerCase().trim()];return h?l(h):null}function d(u){return(n.value[u]||[]).map(v=>l(v)).filter(Boolean)}function f(u){return(s.value[u]||[]).map(v=>l(v)).filter(Boolean)}function c(u){const h=l(u);if(!h)return[];const v=tt(h.content||""),M=o.value;return v.filter(x=>!M[x.toLowerCase().trim()])}function i(u={}){const h=new Date().toISOString(),v={id:Tt(),title:u.title||"未命名笔记",content:u.content||"",articleSlug:u.articleSlug||null,tagIds:u.tagIds||[],pinned:!!u.pinned,createdAt:h,updatedAt:h};return t.value.unshift(v),v}function m(u,h){const v=t.value.findIndex(M=>M.id===u);return v<0?null:(t.value[v]={...t.value[v],...h,updatedAt:new Date().toISOString()},t.value[v])}function _(u){t.value=t.value.filter(h=>h.id!==u)}function P(u){const h=l(u);h&&m(u,{pinned:!h.pinned})}function j({keyword:u="",tagId:h=null,articleSlug:v=null,status:M=null}={}){let x=r.value;if(h&&(x=x.filter(R=>(R.tagIds||[]).includes(h))),v&&(x=x.filter(R=>R.articleSlug===v)),M&&(x=x.filter(R=>(a.value[R.id]?.status||"draft")===M)),u){const R=u.toLowerCase();x=x.filter(J=>(J.title||"").toLowerCase().includes(R)||(J.content||"").toLowerCase().includes(R))}return x}const w=S(()=>({total:t.value.length,pinned:t.value.filter(u=>u.pinned).length,withArticle:t.value.filter(u=>u.articleSlug).length,totalLinks:Object.values(n.value).reduce((u,h)=>u+h.length,0),orphans:t.value.filter(u=>{const h=n.value[u.id]?.length||0,v=s.value[u.id]?.length||0;return h+v===0}).length}));return{notes:t,sorted:r,titleIndex:o,outLinksByNote:n,backlinksByNote:s,inlineTagsByNote:e,metaByNote:a,findById:l,findByTitle:g,getOutLinks:d,getBacklinks:f,getMissingLinks:c,create:i,update:m,remove:_,togglePin:P,search:j,stats:w}});function Pt(){return"t-"+Math.random().toString(36).slice(2,9)}const W=["oklch(0.72 0.21 295)","oklch(0.78 0.18 220)","oklch(0.82 0.16 60)","oklch(0.78 0.18 160)","oklch(0.75 0.20 320)","oklch(0.78 0.15 30)","oklch(0.74 0.17 180)","oklch(0.72 0.20 0)"],it=q("tags",()=>{const t=L([]);F("tags",{tags:t},()=>({tags:st.tags}));const o=S(()=>[...t.value]);function n(d){return t.value.find(f=>f.id===d)}function s(d){return t.value.find(f=>f.name===d)}function e({name:d,color:f}){if(!d)throw new Error("标签名不能为空");if(s(d))throw new Error("同名标签已存在");const c={id:Pt(),name:d,color:f||W[t.value.length%W.length]};return t.value.push(c),c}function a(d,f){const c=t.value.findIndex(i=>i.id===d);c<0||(t.value[c]={...t.value[c],...f})}function r(d){t.value=t.value.filter(f=>f.id!==d)}function l(d){return n(d)?.color||"var(--ink-3)"}function g(d){return n(d)?.name||""}return{tags:t,all:o,palette:W,findById:n,findByName:s,create:e,update:a,remove:r,colorOf:l,nameOf:g}}),ct=q("reads",()=>{const t=L([]);F("reads",{records:t},()=>({records:[]}));function o(c){return t.value.find(i=>i.slug===c)}function n(c){let i=o(c);return i||(i={slug:c,status:"unread",progress:0,rating:0,collected:!1,durationMin:0,lastReadAt:null,finishedAt:null},t.value.push(i)),i}function s(c,i){const m=n(c);Object.assign(m,i),m.lastReadAt=new Date().toISOString(),m.status==="done"&&!m.finishedAt&&(m.finishedAt=m.lastReadAt)}function e(c,i){s(c,{status:i})}function a(c){const i=n(c);i.collected=!i.collected,i.lastReadAt=new Date().toISOString()}function r(c,i){s(c,{rating:i})}function l(c,i){const m=n(c);m.progress=Math.max(m.progress,Math.round(i)),m.lastReadAt=new Date().toISOString(),m.progress>=80&&m.status!=="done"?m.status="done":m.progress>0&&m.status==="unread"&&(m.status="reading")}function g(c,i){const m=n(c);m.durationMin=Math.round((m.durationMin||0)+i),m.lastReadAt=new Date().toISOString()}const d=S(()=>{const c=t.value.length,i=t.value.filter(w=>w.status==="done").length,m=t.value.filter(w=>w.status==="reading").length,_=t.value.filter(w=>w.collected).length,P=t.value.reduce((w,u)=>w+(u.durationMin||0),0),j=t.value.filter(w=>w.rating).reduce((w,u)=>w+u.rating,0)/(t.value.filter(w=>w.rating).length||1);return{total:c,done:i,reading:m,collected:_,totalMin:P,avgRating:j}}),f=S(()=>[...t.value].filter(c=>c.lastReadAt).sort((c,i)=>(i.lastReadAt||"").localeCompare(c.lastReadAt||"")).slice(0,5));return{records:t,get:o,ensure:n,patch:s,setStatus:e,toggleCollect:a,setRating:r,setProgress:l,addDuration:g,stats:d,recent:f}}),ut=(t,o)=>{const n=t.__vccOpts||t;for(const[s,e]of o)n[s]=e;return n},Vt={class:"tqp"},Nt={class:"tqp-stat"},jt={class:"tqp-stat"},zt={class:"ok"},Dt={class:"tqp-stat"},Bt={class:"tqp-stat"},Ht={class:"tqp-stat"},qt={class:"tqp-stat"},Ft={class:"tqp tip"},Wt={__name:"ThemeQuickPanel",setup(t){const o=nt(),n=ct(),s=lt(),e=it(),a=S(()=>{const r=o.name;return{dashboard:"在这里看你的阅读与笔记总览。",library:"点右上 + 加文章。点心形收藏。",notes:"新建时挑一个 Karpathy 模板。",tags:"调色板的颜色会同步到笔记标签。",graph:"拖动节点重排,占位灰节点可一键创建。",stats:"图表会随阅读与笔记数据实时更新。",settings:"记得定期导出 JSON 备份。",chat:"与你的工程问题、灵感、笔记起草过过一遍。"}[r]||"在博客与知识库之间无缝切换。"});return(r,l)=>(k(),A(V,null,[p("div",Vt,[l[6]||(l[6]=p("span",{class:"tqp-label"},"数据快照",-1)),p("div",Nt,[l[0]||(l[0]=p("span",null,"文章",-1)),p("strong",null,E(y(n).stats.total),1)]),p("div",jt,[l[1]||(l[1]=p("span",null,"已读",-1)),p("strong",zt,E(y(n).stats.done),1)]),p("div",Dt,[l[2]||(l[2]=p("span",null,"收藏",-1)),p("strong",null,E(y(n).stats.collected),1)]),p("div",Bt,[l[3]||(l[3]=p("span",null,"笔记",-1)),p("strong",null,E(y(s).stats.total),1)]),p("div",Ht,[l[4]||(l[4]=p("span",null,"双向链接",-1)),p("strong",null,E(y(s).stats.totalLinks),1)]),p("div",qt,[l[5]||(l[5]=p("span",null,"标签",-1)),p("strong",null,E(y(e).tags.length),1)])]),p("div",Ft,[l[7]||(l[7]=p("span",{class:"tqp-label"},"小贴士",-1)),p("p",null,E(a.value),1)])],64))}},Kt=ut(Wt,[["__scopeId","data-v-2245b18f"]]),Zt={class:"ui-toast-stack","aria-live":"polite","aria-atomic":"true"},Gt=["role"],Ut={__name:"AppToastStack",setup(t){const o=G();return(n,s)=>(k(),A("div",Zt,[(k(!0),A(V,null,ot(y(o).toasts,e=>(k(),A("div",{key:e.id,class:ht(["ui-toast",e.type,{leaving:e.leaving}]),role:e.type==="error"||e.type==="warning"?"alert":"status"},E(e.text),11,Gt))),128))]))}},Jt=["width","height","innerHTML"],B={__name:"IconBase",props:{name:{type:String,required:!0},size:{type:[Number,String],default:16}},setup(t){const o={dashboard:'<path d="M3 13h8V3H3v10zM3 21h8v-6H3v6zM13 21h8V11h-8v10zM13 3v6h8V3h-8z" stroke="currentColor" stroke-width="1.6" fill="none"/>',library:'<path d="M4 19V5a2 2 0 012-2h13v18H6a2 2 0 01-2-2zm0 0a2 2 0 012-2h13" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round"/>',notes:'<path d="M14 3H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V9l-6-6z" stroke="currentColor" stroke-width="1.6" fill="none"/><path d="M14 3v6h6M8 13h8M8 17h5" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round"/>',tags:'<path d="M20.59 13.41L13.42 20.58a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linejoin="round"/><circle cx="7" cy="7" r="1.5" fill="currentColor"/>',stats:'<path d="M3 3v18h18M7 14l4-4 4 4 5-7" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',settings:'<circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.6" fill="none"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 01-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 008 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H2a2 2 0 010-4h.09A1.65 1.65 0 003.6 8a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06a1.65 1.65 0 001.82.33H8a1.65 1.65 0 001-1.51V2a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V8a1.65 1.65 0 001.51 1H22a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" stroke="currentColor" stroke-width="1.6" fill="none"/>',search:'<circle cx="11" cy="11" r="7" stroke="currentColor" stroke-width="1.8" fill="none"/><path d="M21 21l-4.35-4.35" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>',plus:'<path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>',check:'<path d="M20 6L9 17l-5-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',close:'<path d="M18 6L6 18M6 6l12 12" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>',trash:'<path d="M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',pin:'<path d="M12 17l-5 4 1.5-6L4 11l6-.5L12 5l2 5.5 6 .5-4.5 4L17 21z" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linejoin="round"/>',star:'<path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linejoin="round"/>',"star-filled":'<path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01z" fill="currentColor"/>',heart:'<path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" stroke="currentColor" stroke-width="1.6" fill="none"/>',"heart-filled":'<path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" fill="currentColor"/>',edit:'<path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7M18.5 2.5a2.12 2.12 0 113 3L12 15l-4 1 1-4 9.5-9.5z" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',eye:'<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="currentColor" stroke-width="1.6" fill="none"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.6" fill="none"/>',"arrow-left":'<path d="M19 12H5M12 19l-7-7 7-7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',"arrow-right":'<path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',"arrow-up":'<path d="M12 19V5M5 12l7-7 7 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',copy:'<rect x="9" y="9" width="13" height="13" rx="2" stroke="currentColor" stroke-width="1.6" fill="none"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1" stroke="currentColor" stroke-width="1.6" fill="none"/>',download:'<path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3" stroke="currentColor" stroke-width="1.7" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',upload:'<path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M17 8l-5-5-5 5M12 3v12" stroke="currentColor" stroke-width="1.7" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',book:'<path d="M4 19.5A2.5 2.5 0 016.5 17H20V2H6.5A2.5 2.5 0 004 4.5v15zM4 19.5V22h16" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',clock:'<circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.6" fill="none"/><path d="M12 7v5l3 2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>',menu:'<path d="M3 6h18M3 12h18M3 18h18" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>',sliders:'<path d="M4 21V14M4 10V3M12 21V12M12 8V3M20 21V16M20 12V3M1 14h6M9 8h6M17 16h6" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round"/>',palette:'<circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.6" fill="none"/><circle cx="7.5" cy="10.5" r="1.5" fill="currentColor"/><circle cx="12" cy="7.5" r="1.5" fill="currentColor"/><circle cx="16.5" cy="10.5" r="1.5" fill="currentColor"/><circle cx="15" cy="15.5" r="1.5" fill="currentColor"/>',graph:'<circle cx="6" cy="6" r="2.5" stroke="currentColor" stroke-width="1.6" fill="none"/><circle cx="18" cy="6" r="2.5" stroke="currentColor" stroke-width="1.6" fill="none"/><circle cx="6" cy="18" r="2.5" stroke="currentColor" stroke-width="1.6" fill="none"/><circle cx="18" cy="18" r="2.5" stroke="currentColor" stroke-width="1.6" fill="none"/><circle cx="12" cy="12" r="2.5" fill="currentColor"/><path d="M7.5 7.5L10 10M16.5 7.5L14 10M7.5 16.5L10 14M16.5 16.5L14 14" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>',link:'<path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" stroke="currentColor" stroke-width="1.7" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',chat:'<path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',key:'<path d="M15 7a4 4 0 11-8 0 4 4 0 018 0zM21 21l-5-5m-2-3.5L18 16m-4-6h.01" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',lab:'<path d="M9 2v6L4 18a2 2 0 001.8 2.9h12.4A2 2 0 0020 18L15 8V2M9 2h6M9 14h6" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/>',guestbook:'<path d="M3 8a4 4 0 014-4h10a4 4 0 014 4v6a4 4 0 01-4 4h-4l-5 4v-4H7a4 4 0 01-4-4V8z" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linejoin="round"/><circle cx="8.5" cy="11" r="1" fill="currentColor"/><circle cx="12" cy="11" r="1" fill="currentColor"/><circle cx="15.5" cy="11" r="1" fill="currentColor"/>'};function n(s){return o[s]||o.close}return(s,e)=>(k(),A("svg",{width:t.size,height:t.size,viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",innerHTML:n(t.name),"aria-hidden":"true"},null,8,Jt))}},Xt={class:"app-nav"},Qt={key:0,class:"nav-links"},Yt={key:0,class:"blog-main"},te={key:1,class:"app-layout"},ee={class:"app-aside"},ne={class:"app-aside-inner"},oe={class:"app-menu"},re={key:0,class:"badge"},se={class:"app-aside-foot"},ae={class:"app-main"},le={class:"app-tools"},ie={class:"app-tools-inner"},ce={__name:"AppLayout",setup(t){const o=nt(),n=vt(),s=lt(),e=it(),a=ct(),r=G(),l=S(()=>o.meta?.layout||"app"),g=L("");function d(){const c=g.value.trim();c&&(n.push({name:"library",query:{q:c}}),r.pushToast("info",`已跳到文章库搜索:"${c}"`))}const f=S(()=>[{to:"/dashboard",label:"仪表板",icon:"dashboard",badge:null},{to:"/library",label:"文章库",icon:"library",badge:null},{to:"/notes",label:"笔记",icon:"notes",badge:s.stats.total},{to:"/tags",label:"标签",icon:"tags",badge:e.tags.length},{to:"/graph",label:"知识图谱",icon:"graph",badge:s.stats.totalLinks||null},{to:"/chat",label:"AI 对话",icon:"chat",badge:null},{to:"/stats",label:"统计",icon:"stats",badge:null},{to:"/settings",label:"设置",icon:"settings",badge:null}]);return(c,i)=>(k(),A(V,null,[p("header",Xt,[b(y(T),{to:"/",class:"brand"},{default:C(()=>[...i[1]||(i[1]=[p("span",{class:"brand-mark"},null,-1),p("span",{class:"brand-text"},"APOS",-1)])]),_:1}),l.value==="blog"?(k(),A("nav",Qt,[b(y(T),{to:"/"},{default:C(()=>[...i[2]||(i[2]=[D("首页",-1)])]),_:1}),b(y(T),{to:"/guestbook"},{default:C(()=>[...i[3]||(i[3]=[D("留言板",-1)])]),_:1}),b(y(T),{to:"/dashboard"},{default:C(()=>[...i[4]||(i[4]=[D("知识库",-1)])]),_:1}),b(y(T),{to:"/playground"},{default:C(()=>[...i[5]||(i[5]=[D("工具间",-1)])]),_:1}),i[6]||(i[6]=p("a",{href:"https://github.com/Apos-DT",target:"_blank",rel:"noopener"},"GitHub ↗",-1))])):(k(),A("form",{key:1,class:"nav-search",onSubmit:ft(d,["prevent"])},[b(B,{name:"search",size:14}),mt(p("input",{"onUpdate:modelValue":i[0]||(i[0]=m=>g.value=m),type:"search",placeholder:"搜索文章 / 笔记 / 标签… (回车跳转文章库)","aria-label":"全局搜索"},null,512),[[gt,g.value]])],32)),l.value==="blog"?(k(),H(y(T),{key:2,class:"nav-cta",to:"/dashboard"},{default:C(()=>[i[7]||(i[7]=p("span",null,"进入应用",-1)),b(B,{name:"arrow-right",size:14})]),_:1})):(k(),H(y(T),{key:3,class:"nav-back",to:"/"},{default:C(()=>[b(B,{name:"arrow-left",size:14}),i[8]||(i[8]=p("span",null,"返回首页",-1))]),_:1}))]),l.value==="blog"?(k(),A("main",Yt,[X(c.$slots,"default",{},void 0)])):(k(),A("div",te,[p("aside",ee,[p("div",ne,[i[10]||(i[10]=p("span",{class:"app-aside-label"},"导航",-1)),p("nav",oe,[(k(!0),A(V,null,ot(f.value,m=>(k(),H(y(T),{key:m.to,to:m.to},{default:C(()=>[b(B,{name:m.icon,size:16},null,8,["name"]),p("span",null,E(m.label),1),m.badge!=null?(k(),A("span",re,E(m.badge),1)):kt("",!0)]),_:2},1032,["to"]))),128))]),p("div",se,[i[9]||(i[9]=p("span",{class:"dot live"},null,-1)),p("span",null,E(y(a).stats.done)+" 已读 · "+E(y(a).stats.reading)+" 在读",1)])])]),p("main",ae,[X(c.$slots,"default",{},void 0)]),p("aside",le,[p("div",ie,[i[11]||(i[11]=p("div",{class:"app-tools-mount"},null,-1)),b(Kt)])])])),b(Ut)],64))}},ue=ut(ce,[["__scopeId","data-v-8b2bcb17"]]),de={__name:"App",setup(t){const o=G();let n=null,s=0;return K(()=>{if(o.applyTheme(),!matchMedia("(prefers-reduced-motion: reduce)").matches){n=new St({duration:1.15,easing:a=>Math.min(1,1.001-Math.pow(2,-10*a)),smoothWheel:!0,smoothTouch:!1});const e=a=>{n.raf(a),s=requestAnimationFrame(e)};s=requestAnimationFrame(e)}}),Z(()=>{s&&cancelAnimationFrame(s),n&&n.destroy()}),(e,a)=>{const r=yt("router-view");return k(),A(V,null,[b(xt),b(Ct),b(ue,null,{default:C(()=>[b(r,null,{default:C(({Component:l,route:g})=>[b(_t,{name:"page",mode:"out-in"},{default:C(()=>[(k(),H(bt(l),{key:g.fullPath}))]),_:2},1024)]),_:1})]),_:1})],64)}}},pe="modulepreload",he=function(t){return"/AposBlog/"+t},et={},$=function(o,n,s){let e=Promise.resolve();if(n&&n.length>0){let r=function(d){return Promise.all(d.map(f=>Promise.resolve(f).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),g=l?.nonce||l?.getAttribute("nonce");e=r(n.map(d=>{if(d=he(d),d in et)return;et[d]=!0;const f=d.endsWith(".css"),c=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${c}`))return;const i=document.createElement("link");if(i.rel=f?"stylesheet":pe,f||(i.as="script"),i.crossOrigin="",i.href=d,g&&i.setAttribute("nonce",g),document.head.appendChild(i),f)return new Promise((m,_)=>{i.addEventListener("load",m),i.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return e.then(r=>{for(const l of r||[])l.status==="rejected"&&a(l.reason);return o().catch(a)})},fe=[{path:"/",name:"home",component:()=>$(()=>import("./HomeView-ZVRoEjj5.js"),__vite__mapDeps([0,1,2,3,4,5])),meta:{title:"首页",layout:"blog"}},{path:"/post/:slug",name:"post",component:()=>$(()=>import("./PostView-DaKrxD3l.js"),__vite__mapDeps([6,1,2,4,7])),meta:{title:"文章",layout:"blog"}},{path:"/playground",name:"playground",component:()=>$(()=>import("./PlaygroundView-Dqsu8g6S.js"),__vite__mapDeps([8,1,4,9])),meta:{title:"工具间",layout:"blog"}},{path:"/dashboard",name:"dashboard",component:()=>$(()=>import("./DashboardView-BUhteBhE.js"),__vite__mapDeps([10,1,2,4,11])),meta:{title:"仪表板",icon:"dashboard",layout:"app"}},{path:"/library",name:"library",component:()=>$(()=>import("./LibraryView-DVkosfm7.js"),__vite__mapDeps([12,1,2,4,13])),meta:{title:"文章库",icon:"library",layout:"app"}},{path:"/library/:slug",redirect:t=>`/post/${t.params.slug}`},{path:"/notes",name:"notes",component:()=>$(()=>import("./NotesView-DSMJiFDi.js"),__vite__mapDeps([14,1,2,4,15])),meta:{title:"笔记",icon:"notes",layout:"app"}},{path:"/notes/:id",name:"noteEdit",component:()=>$(()=>import("./NoteEditView-1rS6guRR.js"),__vite__mapDeps([16,1,2,4,17])),meta:{title:"编辑笔记",icon:"notes",layout:"app"}},{path:"/tags",name:"tags",component:()=>$(()=>import("./TagsView-Dj1g9ADj.js"),__vite__mapDeps([18,1,4,19])),meta:{title:"标签",icon:"tags",layout:"app"}},{path:"/graph",name:"graph",component:()=>$(()=>import("./GraphView-D1pOjk3-.js"),__vite__mapDeps([20,1,2,21,4,22])),meta:{title:"知识图谱",icon:"graph",layout:"app"}},{path:"/chat",name:"chat",component:()=>$(()=>import("./ChatView-CypP7a1C.js"),__vite__mapDeps([23,1,24,4,25])),meta:{title:"AI 对话",icon:"chat",layout:"app"}},{path:"/guestbook",name:"guestbook",component:()=>$(()=>import("./GuestbookView-BbjW9BY6.js"),__vite__mapDeps([26,1,27])),meta:{title:"留言板",icon:"chat",layout:"blog"}},{path:"/stats",name:"stats",component:()=>$(()=>import("./StatsView-DJFjVZVX.js"),__vite__mapDeps([28,2,1,21,4,29])),meta:{title:"统计",icon:"stats",layout:"app"}},{path:"/settings",name:"settings",component:()=>$(()=>import("./SettingsView-BHt1_ekC.js"),__vite__mapDeps([30,1,2,24,4,31])),meta:{title:"设置",icon:"settings",layout:"app"}},{path:"/:pathMatch(.*)*",name:"notFound",component:()=>$(()=>import("./NotFoundView-B2Z-vmh7.js"),__vite__mapDeps([32,1,4,33])),meta:{title:"404",layout:"blog"}}],dt=wt({history:Mt(),routes:fe,scrollBehavior(t,o,n){return n||(t.hash?{el:t.hash,behavior:"smooth"}:{top:0,behavior:"smooth"})}});dt.afterEach(t=>{const o="APOS · 赵祥生";document.title=t.meta?.title?`${t.meta.title} · ${o}`:o});const U=At(de);U.use($t());U.use(dt);U.mount("#app");export{ut as _,B as a,st as b,ve as c,F as d,ke as e,ct as f,G as g,it as h,ye as i,at as p,be as r,_e as s,lt as u};
