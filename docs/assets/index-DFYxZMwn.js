const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomeView-DsjDAeG9.js","assets/vue-CGH0Fj-A.js","assets/posts-VooMR1Rj.js","assets/gsap-CzGW6FVa.js","assets/lenis-BEW9yqGz.js","assets/HomeView-C-BsUXLo.css","assets/PostView-CDcRX3VL.js","assets/PostView-TxfRb_9n.css","assets/PlaygroundView-CvbbAAXh.js","assets/PlaygroundView-eTArX6pP.css","assets/DashboardView-Dro16mLK.js","assets/DashboardView-QLOZTLWq.css","assets/LibraryView-BA33fkZX.js","assets/LibraryView-ANUdwy8k.css","assets/NotesView-Cb9EIWrL.js","assets/NotesView-ClrWPdxR.css","assets/NoteEditView-CpNjgdKy.js","assets/NoteEditView-D6M9MR0M.css","assets/TagsView-BLsvzciY.js","assets/TagsView-DuUoTcNE.css","assets/GraphView--fA19F-C.js","assets/echarts-qCor5qs6.js","assets/GraphView-DLBuAH3j.css","assets/ChatView-DSO1o2ii.js","assets/chat--sfjlcdT.js","assets/ChatView-CcObtQdQ.css","assets/StatsView-BkEgx0qR.js","assets/StatsView-b7id6LJN.css","assets/SettingsView-CZX3aJXc.js","assets/SettingsView-Bw7XPNjJ.css","assets/NotFoundView-CR0PfEPG.js","assets/NotFoundView-OKIYwxCK.css"])))=>i.map(i=>d[i]);
import{H as pt,n as H,u as O,s as K,r as Z,t as k,g as $,d as p,F as N,c as S,B as nt,z as E,A as _,v as ot,p as ht,l as M,I,R as P,k as F,K as ft,J as mt,G as gt,e as B,w as X,C as vt,f as kt,x as yt,a as _t,y as wt,i as bt,m as Mt,b as $t,h as At}from"./vue-CGH0Fj-A.js";import{L as St}from"./lenis-BEW9yqGz.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(e){if(e.ep)return;e.ep=!0;const a=n(e);fetch(e.href,a)}})();const z="apos";function Et(t,o){try{const n=localStorage.getItem(`${z}:${t}`);return n?JSON.parse(n):typeof o=="function"?o():o}catch(n){return console.warn("[apos] loadState failed",t,n),typeof o=="function"?o():o}}function rt(t,o){try{localStorage.setItem(`${z}:${t}`,JSON.stringify(o))}catch(n){console.warn("[apos] saveState failed",t,n)}}function q(t,o,n){const s=Et(t,n);for(const e of Object.keys(o))s&&s[e]!==void 0&&(o[e].value=s[e]);pt(()=>Object.fromEntries(Object.keys(o).map(e=>[e,o[e].value])),e=>rt(t,e),{deep:!0})}function ve(){const t=[];for(let o=0;o<localStorage.length;o++){const n=localStorage.key(o);n&&n.startsWith(`${z}:`)&&t.push(n)}t.forEach(o=>localStorage.removeItem(o))}function ke(){const t={};for(let o=0;o<localStorage.length;o++){const n=localStorage.key(o);if(n&&n.startsWith(`${z}:`))try{t[n.slice(z.length+1)]=JSON.parse(localStorage.getItem(n))}catch{}}return{version:1,exportedAt:new Date().toISOString(),data:t}}function ye(t){if(!t||!t.data)throw new Error("数据格式不正确");Object.entries(t.data).forEach(([o,n])=>{rt(o,n)})}const G=H("settings",()=>{const t=O(295),o=O(16),n=O(!1),s=O([]);q("settings",{hue:t,fontSize:o,reducedMotion:n},()=>({hue:295,fontSize:16,reducedMotion:!1}));function e(){const g=document.documentElement;g.style.setProperty("--accent",`oklch(0.72 0.21 ${t.value})`),g.style.fontSize=o.value+"px"}function a(g){t.value=Math.max(0,Math.min(360,parseInt(g,10)||0)),e()}function r(g){o.value=parseInt(g,10)||16,e()}function l(g,d,f=2800){const c=Math.random().toString(36).slice(2);s.value.push({id:c,type:g,text:d}),setTimeout(()=>{const i=s.value.findIndex(m=>m.id===c);i>=0&&(s.value[i].leaving=!0),setTimeout(()=>{s.value=s.value.filter(m=>m.id!==c)},300)},f)}return{hue:t,fontSize:o,reducedMotion:n,toasts:s,applyTheme:e,setHue:a,setFontSize:r,pushToast:l}}),xt={__name:"AppBackground",setup(t){const o=O(null);let n=null;return K(()=>{const s=o.value?o.value.querySelectorAll(".blob"):[];if(!s.length)return;const e=a=>{const r=a.clientX/window.innerWidth-.5,l=a.clientY/window.innerHeight-.5;s.forEach((g,d)=>{const f=(d+1)*14;g.style.transform=`translate3d(${r*f}px, ${l*f}px, 0)`})};window.addEventListener("mousemove",e,{passive:!0}),n=()=>window.removeEventListener("mousemove",e)}),Z(()=>n&&n()),(s,e)=>(k(),$(N,null,[e[1]||(e[1]=p("div",{class:"app-bg-grain","aria-hidden":"true"},null,-1)),p("div",{ref_key:"blobsEl",ref:o,class:"app-bg-aurora","aria-hidden":"true"},[...e[0]||(e[0]=[p("span",{class:"blob a"},null,-1),p("span",{class:"blob b"},null,-1),p("span",{class:"blob c"},null,-1)])],512)],64))}},Ot={__name:"AppCursor",setup(t){const o=O(null),n=O(null);let s=0,e=null;return K(()=>{if(!matchMedia("(hover: hover)").matches)return;const a={x:innerWidth/2,y:innerHeight/2},r={x:a.x,y:a.y},l=(y,T,j)=>y+(T-y)*j,g=y=>{a.x=y.clientX,a.y=y.clientY};window.addEventListener("mousemove",g,{passive:!0});const d=()=>{r.x=l(r.x,a.x,.16),r.y=l(r.y,a.y,.16),o.value&&(o.value.style.transform=`translate3d(${a.x-3}px, ${a.y-3}px, 0)`),n.value&&(n.value.style.transform=`translate3d(${r.x-18}px, ${r.y-18}px, 0)`),s=requestAnimationFrame(d)};d();const f=()=>document.body.classList.add("cursor-hover"),c=()=>document.body.classList.remove("cursor-hover"),i=()=>{document.querySelectorAll('a, button, .ui-card, .post-card, [data-cursor="link"]').forEach(y=>{y.addEventListener("mouseenter",f),y.addEventListener("mouseleave",c)})};i();const m=new MutationObserver(()=>i());m.observe(document.body,{childList:!0,subtree:!0}),e=()=>{cancelAnimationFrame(s),window.removeEventListener("mousemove",g),m.disconnect(),c()}}),Z(()=>e&&e()),(a,r)=>(k(),$(N,null,[p("div",{ref_key:"dot",ref:o,class:"app-cursor-dot","aria-hidden":"true"},null,512),p("div",{ref_key:"ring",ref:n,class:"app-cursor-ring","aria-hidden":"true"},null,512)],64))}},Ct=[{slug:"odoo-erp-manufacturing-customization",title:"在 Odoo 里做制造业 ERP 二开:销采产存质财全链路笔记",excerpt:"从客户手工 Excel 跑产线,到 Odoo 把销售-采购-库存-生产-质检-财务跑通。这篇拆开几个月里的关键二开决策与踩坑。",tag:"ERP",date:"2026-05-13",readTime:12,external:!1,url:"../../post.html?slug=odoo-erp-manufacturing-customization"},{slug:"industrial-vision-system-pitfalls",title:"工业机器视觉现场交付的 5 个稳定性陷阱",excerpt:"上位机/下位机联调、产线异常定位、通信稳定性优化——实验室能跑、现场就崩的真实原因。",tag:"Vision",date:"2026-04-22",readTime:10,external:!1,url:"../../post.html?slug=industrial-vision-system-pitfalls"},{slug:"springboot-vue-fullstack-craft",title:"Spring Boot + Vue3 全栈工程化:从权限到大屏的实战沉淀",excerpt:"在既有项目上做功能迭代、权限增强、数据可视化大屏。Spring Boot + Vue3 的连接处藏着多少坊。",tag:"Fullstack",date:"2025-09-18",readTime:8,external:!1,url:"../../post.html?slug=springboot-vue-fullstack-craft"},{slug:"python-scraping-pandas-django",title:"用 Selenium + Pandas + Django 做一套招聘数据采集分析",excerpt:"从爬取动态页面,到 Pandas 清洗,再到 Django 可视化展示——一个完整的数据小项目从 0 到 1。",tag:"Data",date:"2025-06-08",readTime:7,external:!1,url:"../../post.html?slug=python-scraping-pandas-django"}],Lt=[{id:"t-erp",name:"ERP",color:"oklch(0.74 0.20 295)"},{id:"t-vision",name:"Vision",color:"oklch(0.80 0.17 220)"},{id:"t-fullstack",name:"Fullstack",color:"oklch(0.84 0.15 60)"},{id:"t-data",name:"Data",color:"oklch(0.80 0.17 160)"},{id:"t-study",name:"学习",color:"oklch(0.77 0.18 320)"},{id:"t-think",name:"思考",color:"oklch(0.80 0.15 30)"},{id:"t-cheat",name:"速查",color:"oklch(0.76 0.17 180)"}],It=[{id:"n-welcome",title:"欢迎使用 APOS 知识库",content:`---
type: meta
status: pinned
date: 2026-05-20
---
