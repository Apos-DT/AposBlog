import{H as X,r as ke,g as o,e as V,L as Q,d as n,F as f,v as b,A as S,f as E,T as be,l as d,z as u,p as P,J as W,G as Z,I as q,k as y,R as U,E as ye,u as h,c as L,o as G,C as he,B as we,t as a,q as $e}from"./vue-DuDYKpJ_.js";import{u as _e,s as ee,r as Ie,p as Ce}from"./notes-IOkGqXDM.js";import{u as Se}from"./tags-CeGYaKJ7.js";import{u as xe}from"./posts-CKwYp-sX.js";import{_ as Te,u as Ne,a as c}from"./index-DIqGHuta.js";import"./initial-BqkmhB2L.js";import"./lenis-BEW9yqGz.js";const ze=[{id:"blank",name:"空白",desc:"完全自由,无任何预设结构",icon:"plus",build:()=>({title:"未命名笔记",content:""})},{id:"postmortem",name:"项目复盘",desc:"Karpathy 风:背景 / 我做了什么 / 工作的 / 不工作的 / 教训 / 下一步",icon:"book",build:()=>({title:"复盘:[项目名]",content:`---
type: postmortem
status: draft
date: ${w()}
project:
