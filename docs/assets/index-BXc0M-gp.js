...
#Vision #速查`,articleSlug:"industrial-vision-system-pitfalls",tagIds:["t-vision","t-cheat"],pinned:!1,createdAt:"2026-04-22T08:00:00.000Z",updatedAt:"2026-04-22T08:00:00.000Z"}],st={posts:Ot,tags:Ct,notes:It};function at(t){if(typeof t!="string")return{meta:{},body:t||""};const o=t.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n?([\s\S]*)$/);if(!o)return{meta:{},body:t};const n={};return o[1].split(/\r?\n/).forEach(s=>{const e=s.match(/^([a-zA-Z0-9_-]+):\s*(.*)$/);if(!e)return;const a=e[1];let r=e[2].trim();if(!r){n[a]="";return}if(/^\[.*\]$/.test(r)){n[a]=r.slice(1,-1).split(",").map(l=>l.trim().replace(/^["']|["']$/g,"")).filter(Boolean);return}if(/^-?\d+(\.\d+)?$/.test(r)){n[a]=Number(r);return}if(r==="true"||r==="false"){n[a]=r==="true";return}n[a]=r.replace(/^["']|["']$/g,"")}),{meta:n,body:o[2]}}function _e(t,o){const n=Object.keys(t||{}).filter(e=>t[e]!==""&&t[e]!=null);if(!n.length)return o||"";const s=["---"];return n.forEach(e=>{const a=t[e];Array.isArray(a)?s.push(`${e}: [${a.map(r=>JSON.stringify(r)).join(", ")}]`):typeof a=="string"&&/[:#\[\]]/.test(a)?s.push(`${e}: ${JSON.stringify(a)}`):s.push(`${e}: ${a}`)}),s.push("---",""),s.join(`
`)+(o||"")}const Q=/\[\[([^\]|]+?)(?:\|([^\]]+?))?\]\]/g,Y=/(^|[\s\(])#([a-zA-Z0-9_\-一-龥]{1,30})\b/g;function tt(t){if(!t)return[];const o=new Set;let n;for(Q.lastIndex=0;(n=Q.exec(t))!==null;)o.add(n[1].trim());return Array.from(o)}function Rt(t){if(!t)return[];const o=new Set;let n;for(Y.lastIndex=0;(n=Y.exec(t))!==null;)o.add(n[2]);return Array.from(o)}function C(t){return String(t).replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function O(t){return C(t)}function be(t,o={}){const{body:n}=at(t||""),s=o.onLink||(()=>null),e=n.replace(/\r\n/g,`
`).split(`
`),a=[];let r=0;for(;r<e.length;){const l=e[r];if(/^```/.test(l)){const f=l.replace(/^```/,"").trim(),c=[];for(r++;r<e.length&&!/^```/.test(e[r]);)c.push(e[r]),r++;r++,a.push(`<pre><code${f?` data-lang="${O(f)}"`:""}>${C(c.join(`
